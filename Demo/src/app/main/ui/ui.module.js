(function ()
{
    ...
    angular
        .module('app.ui', [
            'app.ui.forms',
			'app.ui.elements.icons',
            'app.ui.elements.material-colors',
            ...
            'app.ui.elements.theme-colors',
            'app.ui.elements.typography'
        ])
        .config(config);
    ...
    function config(msNavigationServiceProvider)
    {
        ...
        msNavigationServiceProvider.saveItem('ui.forms', {
            title: 'Input Form Samples',
            icon : 'icon-window-restore',
            state: 'app.ui_forms'
        });

        msNavigationServiceProvider.saveItem('ui.elements', {
		...
		msNavigationServiceProvider.saveItem('ui.elements.icons', {
            title: 'Icons',
            icon : 'icon-file-image-box',
            state: 'app.ui_elements_icons'
        });

        msNavigationServiceProvider.saveItem('ui.elements.typography', {
            title: 'Typography',
            icon : 'icon-format-size',
            state: 'app.ui_elements_typography'
        });

        msNavigationServiceProvider.saveItem('ui.elements.theme-colors', {
            title: 'Theme Colors',
            icon : 'icon-palette-advanced',
            state: 'app.ui_elements_theme-colors'
        });

        msNavigationServiceProvider.saveItem('ui.elements.material-colors', {
            title: 'Material Colors',
            icon : 'icon-palette',
            state: 'app.ui_elements_material-colors'
        });
